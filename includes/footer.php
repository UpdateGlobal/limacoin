...
<footer class="site-footer bg-no-repeat bg-full-height bg-center"  style="background-color: black;">
    ...
    <p>Somos un grupo de jóvenes emprendedores que visionamos en el mundo de las criptomonedas una nueva forma de economía digital y evolución del dinero es así que nace limacoin quien se suma a esta nueva tendencia tecnológica de las criptodivisas.</p>
    </div>
    </div>
    </div>
    <div class="row">
    ...
    <p>Jr. Ayacucho 456 <br> San Miguel Lima</p>
    </div>
    </div>
    </div>
    <div class="col-md-4 col-sm-6  p-tb20 ">
